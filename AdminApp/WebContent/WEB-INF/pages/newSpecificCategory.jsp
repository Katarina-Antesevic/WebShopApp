...
<head>
    <meta charset="UTF-8">
    <title>Kreiranje nove specificne kategorije</title>
...
<body>
    <nav class="navbar navbar-expand-sm navbar-dark bg-secondary sticky-top">
      ...
      <form method="POST" action="?action=saveSpecific" class="form-new-Cat">
        <h2 class="form-heading">Kreiranje nove specificne kategorije</h2>
        <p></p>
        <p></p>
        <input  name="naziv" type="text" class="form-control" placeholder="Naziv specificne kategorije">
        
        <label style="font-size:20px;">Odaberite kojoj kategoriji pripada</label>
	   ...
	   %>
		 ...
		 <p></p>
        <h5><%=session.getAttribute("notificationNine").toString()%></h5>
